...
class Road:
    ...
    def calc(self):
        volume_of_asphalt = (self._width * self._length * 25 * 5) / 1000
        print(f'Для покрытия дорожного полотна потребуется {volume_of_asphalt} тонн')


lenin_street = Road(6000, 50)
lenin_street.calc()
